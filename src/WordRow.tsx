...
function CharacterCubes ({value, state} : CharacterBoxProps) {
    ...
    return(
    <div className={`inline-block border-2 mx-1 border-solid border-gray-500 p-4 uppercase text-lg font-bold text-center before:inline-block before:content-[' '] ${stateStyles}`}>
        {value}
    </div>
    )
}
